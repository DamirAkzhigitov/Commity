...
## Goal
Move from empty modules to a usable, testable Android-first core loop: secure sign in, fixed Chat/Tasks/Reminders/Settings tabs, chat, receive structured action proposals, save confirmed Tasks/Subitems/Documents/Reminders locally in encrypted storage, schedule local reminders, and enforce backend AI usage limits.
...
- [ ] The app can confirm and save Tasks, Subitems, Documents, and Reminders locally.
- [ ] The Tasks tab shows outcome-oriented Tasks with Subitems and Documents.
