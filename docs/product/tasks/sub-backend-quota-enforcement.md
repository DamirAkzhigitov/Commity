...
## Acceptance Criteria
- [ ] Given a Free user, when they exceed the free daily/monthly quota, then the API returns a 403/429 error indicating quota exceeded.
- [ ] Given a Pro user, when they make requests, then they are allowed up to the Pro quota limit.
