...
- Mobile builds a bounded context packet from recent chat and relevant local items.
...
- Reminder proposals schedule local notifications only after user confirmation.
